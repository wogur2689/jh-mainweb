...
<div id="container">
	<div id="header">
		...
		?>
						...
						<div class="login_tema_after">
						<a href="mypage_change.php">수정하기</a>
						</div>
						<div class="login_tema_after">
		...
		<div id="contents-data">
            ...
            <ul>
                <li>
                    <span class="data">아이디</span><?=$id?>
                </li>
                <li>
                    <span class="data">이름</span><?=$name?>
                </li>
                <li>
                    <span class="data">비밀번호</span><?=$password?>
                </li>
                <li>
                    <span class="data">성별</span><?=$gender?>
                </li>
                <li>
                    <span class="data">핸드폰번호</span><?=$phoneNumber?>
                </li>
                <li>
                    <span class="data">이메일</span><?=$email?>
                </li>
                <li>
                    <span class="data">나이</span><?=$age?>
                </li>
                <li>
	...
	<script type="text/javascript">
		function del(){
			...
			if(result) {
				location.href = 'mypage_delete.php';
			} else {
				alert("탈퇴 취소되었습니다!");
			}
		}
