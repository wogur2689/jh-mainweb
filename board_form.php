	    ...
	    <form  name="board_form" method="post" action="board_insert.php" enctype="multipart/form-data">
	    	 <ul id="board_form">
	    		...
	    		<li>
	    			...
	    			<span class="col2"><input name="subject" type="text" class="subject" placeholder="제목을 입력하세요."></span>
	    		</li>	    	
	    		<li id="text_area">	
	    			<span class="col1">내용 : </span>
	    			<span class="col2">
	    				<textarea name="content" class="content" placeholder="내용 입력"></textarea>
	    			</span>
	    		</li>
	    		<li>
				...
				<button class="gle" type="button" onclick="check_input()">올리기</button>
